...
def main():
    ...
    ax[0].set_xlabel(("dots represent end of week with "
                      "largest yearly planting percentage"))
    prop = matplotlib.font_manager.FontProperties(size=12)

    ax[0].legend(ncol=2, loc=4, prop=prop)
    ax[0].set_xticks([91, 105, 121, 135, 152, 166, 182, 213, 244,
                      274, 305, 335, 365])
    ax[0].set_xticklabels(('Apr 1', 'Apr 15', 'May 1', 'May 15', 'Jun 1',
                           'Jun 15', 'Jul 1', 'Aug', 'Sep', 'Oct',
                           'Nov', 'Dec'))
    ax[0].set_xlim(90, 170)
    ax[0].set_yticks(range(0, 101, 25))
    ax[0].grid(True)
    ax[0].set_title(("USDA Weekly Crop Progress Report (1979-2018)\n"
