...
ax[0].xaxis.set_major_locator(mdates.DayLocator(interval=1, tz=iemtz.Central))
...
ax[1].xaxis.set_major_locator(mdates.DayLocator(interval=1, tz=iemtz.Central))
