...
def main():
    ...
    WHERE t.network = 'IACOCORAHS' and s.day >= '2019-06-01' and pday > 0)
    ...
    mp = MapPlot(
        ...
        subtitle=(
            "Sites with at least one report in past year (June 2019-2020)"
        ),
    )
    ...
    mp.drawcounties()
    mp.postprocess(filename="200625.png")
