...
ax[1].set_xlabel(
    "*2014 thru 1 August, yearly totals don't match official data due to missing obs",
    fontsize=10,
)
...
ax[1].bar(
    numpy.arange(2002, 2015) - 0.4, p2, bottom=p, fc="b", label="+/- 1 hour"
)
