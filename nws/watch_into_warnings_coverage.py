...
xs = ['0', '1-10', '11-20', '21-30', '31-40', '41-50', '51-60', '61-70',
      '71-80', '81-90', '91-100']
ys = [len(df[df['percent'] == 0].index) / total * 100.]
for x in xs[1:]:
    x1, x2 = [float(i) for i in x.split("-")]
    ys.append(len(df[(df['percent'] >= x1) & (df['percent'] < (x2+1))].index) /
              total * 100.)
...
ax.set_xlabel(("Percentage of Counties/Parishes in Svr Tstorm Watch "
