...
def main():
    ...
    acursor.execute(
        """SELECT data, entered from products_2005_0712
        WHERE pil = 'TCDAT2'
    ...
    ax.set_xlabel(
        (
            "Forecasts made between 4 PM 23 Aug 2005\n"
            "and 10 AM 30 Aug 2005, outlined is observation"
        ),
        size=14,
    )
    ax.legend(
        [l2, l3, l4],
        ["Tropical Storm", "Category 1", "Category 2"],
        prop=prop,
        loc=2,
    )
