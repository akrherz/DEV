...
m = MapPlot(sector='custom', north=42.69, east=-93.1, south=41.77, west=-94.1,
            axisbg='white',
  title='NOAA MRMS Q3: RADAR Estimated + Gauge Corrected Precipitation',
  subtitle='Valid: 8 PM 26 June - 8 PM 29 June 2016')
...
"""
grbs = pygrib.open('MRMS_GaugeCorr_QPE_72H_00.00_20170630-010000.grib2')
g = grbs.message(1)
