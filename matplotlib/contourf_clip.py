...
that
    ...
    print bound_verts + poly_verts, bound_codes + poly_codes
    print poly_verts
    # Plot the masking patch
    path = mpath.Path(bound_verts + poly_verts, bound_codes + poly_codes)
    patch = mpatches.PathPatch(path, facecolor='white', edgecolor='b',
            zorder=3)
...
m = Basemap(llcrnrlon=-100.,llcrnrlat=38.,urcrnrlon=-90.,urcrnrlat=44.,
