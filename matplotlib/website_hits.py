...
ax.bar(df['valid'].values, df['hits'].values, width=1/86400., ec='b', fc='b')
ax.grid(True)
ax.set_xlim(datetime.datetime(2016, 11, 2, 22, 15),
...
ax.annotate("10:23 PM\nRain Starts",
            xy=(datetime.datetime(2016, 11, 2, 22, 23), 20000.),
            xycoords='data', xytext=(-50, 30), textcoords='offset points',
            bbox=dict(boxstyle="round", fc="0.8"),
            arrowprops=dict(arrowstyle="->",
                            connectionstyle="angle,angleA=0,angleB=90,rad=1"))
ax.annotate("10:54 PM\nTarp is Rolled Out!",
            xy=(datetime.datetime(2016, 11, 2, 22, 54), 20000.),
            xycoords='data', xytext=(-50, 30), textcoords='offset points',
            bbox=dict(boxstyle="round", fc="0.8"),
            arrowprops=dict(arrowstyle="->",
                            connectionstyle="angle,angleA=0,angleB=90,rad=1"))
