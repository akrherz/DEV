...
cs = ax.imshow(data, aspect='auto', cmap=cmap3, interpolation='nearest',
               norm=norm)

ax3 = plt.axes([0.92, 0.1, 0.02, 0.8], frameon=False,
                      yticks=[], xticks=[])

cb2 = mpl.colorbar.ColorbarBase(ax3, cmap=cmap3,
                                     norm=norm,
