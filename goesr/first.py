...
def main():
    ...
    LCC = pyproj.Proj(
        (
            "+lon_0=-95. +y_0=0.0 +R=6371200. +proj=lcc +x_0=0.0"
    ...
    m = MapPlot(
        ...
        facecolor="white",
        statecolor="r",
        title=r"GOES-R 0.64 $\mu$m ABI Channel 2 on 2 March 2017 3:30 PM CST",
    ...
    for sector in ["I", "J", "C", "D"]:
        ...
        m.pcolormesh(
            ...
            lat,
            vals,
            np.arange(0.02, 0.78, 0.02),
            cmap=cmap,
            clip_on=False,
            clevstride=5,
            units="TOA Bidirectional Reflectance",
        )
