...
PRECIP_AFF = Affine(0.01, 0.0, GRIDWEST, 0.0, -0.01, GRIDNORTH)
...
rng = np.arange(-10, 11, 2.0)
res = m.pcolormesh(lons, lats, vals, rng, cmap=cmap, units="events per year")
res.set_rasterized(True)
m.ax.text(
    0.01,
    0.04,
    (
        "Postive values mean higher Day 1 Slight Risk\n"
